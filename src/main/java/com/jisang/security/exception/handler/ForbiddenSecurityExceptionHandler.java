...
/**
 * 
 * spring security의 {@link AccessDeniedException}에 대한 {@link SecurityExceptionHandler} 구현이다.
 * 
 * @author leeseunghyun
 *
 */
public class ForbiddenSecurityExceptionHandler extends AbstractSecurityExceptionHandler<AccessDeniedException> {
	...
	/**
	 * 
	 * 이 메서드 구현은 단순히  HTTP 응답 403 - Forbidden을 나타내는 {@link SimpleResponseDTO}를 반환한다. 반환 되는 DTO는 항상 같은 응답 
