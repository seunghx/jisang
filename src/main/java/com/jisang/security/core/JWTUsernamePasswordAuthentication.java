...
/**/
/**
 * 폼 로그인 인증을 위해 사용될 목적의 {@link JWTAuthentication} 구현 클래스이다. 폼 로그인 인증에 사용되므로
 * user의 아이디와 패스워드를 반환한다. 사실상 하는 일은 {@link UsernamePasswordAuthenticationToken}과
 * 동일하지만 기능이 단순하기 때문에 따로 {@link UsernamePasswordAuthenticationToken}을 사용하거나 내부
 * 프로퍼티로 두어 위임하는 방법으로 구현하지는 않았다.
 * 
 * 
 * @author leeseunghyun
 * 
