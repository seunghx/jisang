...
/**
 * 
 * 익명 사용자(로그인 하지 않은 사용자)의 인증 정보 {@link AnonymouUserAuthTokenDTO}를 담고 있는 {@link Authentication} 구현이다.
 * 
 * 단순히 {@link AnonymouUserAuthTokenDTO} 전달하는 일 외에 다른 메서드들은 지원하지 않는다. 스프링 시큐리티 {@code Authentication Filter}의
