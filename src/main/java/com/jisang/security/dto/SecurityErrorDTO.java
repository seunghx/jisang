...
public class SecurityErrorDTO {
	...
	public SecurityErrorDTO(int status) {
		this.status = status;
	}
		
	public SecurityErrorDTO(int status, String message) {
		this(status);
	...
	/**
	 * 
	 * 예외 상황에 대한 Detail한 정보를 담는다. 
	 * 예를 들어, 바인딩 과정에 예외가 발생할 경우 예외가 발생한 위치와 해당 프로퍼티에 지정된 검증 메세지 정보를 담는다.
	 * 
	 * @author leeseunghyun
	 *
	 */
