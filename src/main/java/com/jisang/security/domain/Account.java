...
/**
 * 
 * 지상 어플리케이션의 security 단에서 인증에 사용될 유저의 계정 정보를 담은 클래스이다. 비록 유저의 {@code id},
 * {@code role}, {@code password} 정보 밖에 없지만 seucirty 단 입장에서는 도메인이라고 볼 수 있다는 생각에
 * {@code com.jisang.security.domain} 패키지에 두었다.
 * 
 * 
 * @author leeseunghyun
 *
