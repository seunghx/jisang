...
@ComponentScan(basePackages = { "com.jisang.service", "com.jisang.validation", "com.jisang.support",
        "com.jisang.domain", "com.jisang.persistence", "com.jisang.aop", "com.jisang.config.code" })
...
public class AppConfig {
    ...
    public AmazonSNS amazonSNS() {
        ...
        AmazonSNS snsClient = AmazonSNSClientBuilder.standard().withRegion(Regions.fromName(awsSnsRegion))
