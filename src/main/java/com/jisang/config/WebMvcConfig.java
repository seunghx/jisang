...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("JISANG REST API", "지상 어플리케이션에서 지원하는 각 url에 대한 API 명세.", "JISANG API Version 1.0.0",
                "Terms of service", new Contact("Lee seunghyun", "", "seunghx@naver.com.com"),
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/asset/**").addResourceLocations("/WEB-INF/asset/");
    }
