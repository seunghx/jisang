...
public class ProductServiceImpl implements ProductService {
    ...
    private PagenationProductListView findProductListPage(ProductListViewConfigData viewConfig) {
        ...
        PageViewCriteria criteria = new PageViewCriteriaBuilder(viewConfig.getMarketId(), viewConfig.getMallLocation(),
                viewConfig.getCategory(), totalCount).pageIndex(viewConfig.getPageIndex())
                        ...
                        .searchKeyword(viewConfig.getSearchCriteria().getKeyword()).build();
        ...
        viewDTO.setProductEntityList(productList.stream()
                .map(product -> modelMapper.map(product, ProductListViewEntity.class)).collect(Collectors.toList()));
    ...
    private ProductListView findProductListBest(ProductListViewConfigData viewConfig) {
        ...
        BestViewCriteria criteria = new BestViewCriteriaBuilder(viewConfig.getMarketId(), viewConfig.getMallLocation(),
                viewConfig.getCategory(), viewConfig.getBestViewCnt()).pastHitWeight(pastHitWeight)
    ...
    private ProductListView findProductListRecommended(ProductListViewConfigData viewConfig) {
        ...
        RecommendedViewCriteria criteria = new RecommendedViewCriteriaBuilder(viewConfig.getMarketId(),
                viewConfig.getMallLocation(), viewConfig.getCategory(), viewConfig.getRecommendedViewCnt())
                        .searchKeyword(viewConfig.getSearchCriteria().getKeyword()).build();
    ...
    public List<ManagementProductListView> findProductListForManagement(int managerId) {
        ...
        Map<LocalDate, List<Product>> productListGroupedByDate = productDAO.readListByMarketId(marketId).stream()
    ...
    private void registerProductInternal(Product product) {
        ...
        product.getHashTags().stream().forEach(hashTag -> {
